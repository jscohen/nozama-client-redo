...
/***/ (function(module, exports, __webpack_require__) {
	...
	var productsEvents = __webpack_require__(41);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://nozama-api-redo.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(40);
	...
	var onSignIn = function onSignIn(event) {
	  var data = getFormFields(this);
	  console.log('inside events', data);
	  event.preventDefault();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var addToCart = function addToCart(data) {
	  ...
	  for (var i = 0; i < store.cart.products.length; i++) {
	    if (data.sku === store.cart.products[i].sku) {
	      ...
	      api.update(_params, 'changeQuantity').then(ui.onAddDupSuccess).catch(ui.onUpdateCartFailure);
	      return false;
	    }
	  }
	...
	function updateQuantity(quantityInput) {
	  ...
	  var prodId = productRow.attr('id');
	  var prodApi = __webpack_require__(36);
	  var prodUi = __webpack_require__(37);

	  prodApi.show(prodId).then(addQuantToProduct).catch(prodUi.getProductFailure).then(function () {
	    return productRow.children('.product-line-price').each(function () {
	...
	function addQuantToProduct(data) {
	  var newTotalPrice = store.cart.totalPrice + data.product.price * (store.quantity - 1);
	  store.cart.totalPrice = newTotalPrice;
	  var pri = data.product.price * store.quantity;
	  ...
	  api.update(params, 'changeQuantity').then(ui.onUpdateCartSuccess).catch(ui.onUpdateCartFailure);
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onAddDupSuccess = function onAddDupSuccess(data) {
	...
	module.exports = {
	  ...
	  onAddDupSuccess: onAddDupSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var showProductsTemplate = __webpack_require__(38);
	...
	var getProductFailure = function getProductFailure(error) {
	  console.log(error);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var prod = __webpack_require__(41);
	...
	var checkout = function checkout(event) {
	  var addressFunc = __webpack_require__(47);
	...
	var showOrderForm = function showOrderForm() {
	  var addressAPI = __webpack_require__(47);
	...
	var getSavedAddress = function getSavedAddress(event) {
	  console.log('inside saved address');
	  event.preventDefault();
	  var val = $('.address-display').find(':selected').text();
	  var newString = val.trim();
	  var newStringSplit = newString.split('\n');
	  console.log(newStringSplit);
	  var street = newStringSplit[0].split(':');
	  var city = newStringSplit[1].split(':');
	  var state = newStringSplit[2].split(':');
	  var zip = newStringSplit[3].split(':');
	  var country = newStringSplit[4].split(':');
	  var finalStreet = street[1].trim();
	  var finalCity = city[1].trim();
	  var finalState = state[1].trim();
	  var finalZip = zip[1].trim();
	  var finalCountry = country[1].trim();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createOrderSuccess = function createOrderSuccess() {
	  ...
	  var api = __webpack_require__(13);
	  var ui = __webpack_require__(14);
	  api.destroy().then(ui.deleteCartSuccess).catch(ui.deleteCartFailure).then(cartApi.createCart);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createAddress = function createAddress(data) {
	  var address = data;
	  api.create(address).then(ui.onCreateAddressSuccess).catch(ui.onCreateAddressFailure);
	};
	var getAddresses = function getAddresses(data) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateAddressSuccess = function onCreateAddressSuccess(data) {
	  console.log(data);
	  console.log('address created');
	};

	var onCreateAddressFailure = function onCreateAddressFailure(error) {
	  console.log(error);
	};

	var onGetAddressSuccess = function onGetAddressSuccess(data) {
	  var showAddressTemplate = __webpack_require__(50);
	  store.addresses = data;
	  console.log(store.addresses.address);
	  console.log('get address success');
	  var showAddressesHTML = showAddressTemplate({
	...
	var onGetAddressFailure = function onGetAddressFailure(error) {
	  console.log(error);
	};

	module.exports = {
	  onCreateAddressSuccess: onCreateAddressSuccess,
	  onCreateAddressFailure: onCreateAddressFailure,
	  onGetAddressSuccess: onGetAddressSuccess,
	  onGetAddressFailure: onGetAddressFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <option class=\"address\" value=\"test\">\n  Address: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.street : stack1), depth0))
	    + " <br />\n  City: "
	    ...
	    + "<br />\n  Zip: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.zip : stack1), depth0))
	    + "<br />\n  Country: "
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.address : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
